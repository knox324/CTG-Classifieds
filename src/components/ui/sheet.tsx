...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background/80 backdrop-blur-lg p-6 shadow-2xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:duration-200",
  {
    variants: {
      side: {
